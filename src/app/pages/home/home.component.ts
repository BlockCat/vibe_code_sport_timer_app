...
export class HomeComponent {
  ...
  constructor(private router: Router, private workoutStreakService: WorkoutStreakService) { }
  ...
  workouts(): { title: string, id: string, description: string, duration: number, currentStreak: number }[] {
